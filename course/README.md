...
An undergraduate course in thirteen lectures, locked 1:1 with the companion book of chapter
notebooks (`chapters/`) — L0 is chapter 00, L12 is chapter 12, in order. **Every figure the
...
Every lecture runs its full intro → core → math depth (71 slides across the 13 lectures, sized to
